...
class Solution:
    def maxPoints(self, points: List[List[int]]) -> int:
        ...
        def line(p1, p2):
            ...
            b = p1[1] - slope * p1[0]
            return (slope,
                    "%.5f" % b)  # Floating Point has issues and limitations, using floating point as hash key isn't a good iead, so round it up a little bit. Check the comment below for the issue.
